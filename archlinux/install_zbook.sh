...
options rd.luks.name=<UUID>=cryptlvm root=LABEL=lv_root rw resume=LABEL=lv_swap" > /mnt/boot/loader/entries/arch.conf
...
options rd.luks.name=<UUID>=cryptlvm root=LABEL=lv_root rw resume=LABEL=lv_swap" > /mnt/boot/loader/entries/arch-lts.conf
...
options rd.luks.name=<UUID>=cryptlvm root=LABEL=lv_root rw resume=LABEL=lv_swap" > /mnt/boot/loader/entries/arch-fallback.conf
...
options rd.luks.name=<UUID>=cryptlvm root=LABEL=lv_root rw resume=LABEL=lv_swap" > /mnt/boot/loader/entries/arch-lts-fallback.conf
